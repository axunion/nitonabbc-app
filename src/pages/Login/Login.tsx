  ...
  return (
    <div class={styles.container}>
      <div class={styles.card}>
        <h1 class={styles.title}>{t("common.churchName")}</h1>
        <p class={styles.subtitle}>{t("login.subtitle")}</p>
        <a href="/api/auth/login" class={styles.lineButton}>
          <svg
            class={styles.lineLogo}
